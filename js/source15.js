function calculateEmissionsForSource15() {
    ...
    document.getElementById('c1c5_year').textContent = M_HC_C1C5_final.toFixed(6);
    document.getElementById('c1c5_peak').textContent = G_HC_C1C5_final.toFixed(6);

function calculateEmissionsForSource13() {
    ...
    document.getElementById('hcC1C5_year').textContent = M_HC_C1C5_final.toFixed(4);
    document.getElementById('hcC1C5_peak').textContent = G_HC_C1C5_final.toFixed(6);
    ...
    document.getElementById('hcC6C10_year').textContent = M_HC_C6C10_final.toFixed(4);
    document.getElementById('hcC6C10_peak').textContent = G_HC_C6C10_final.toFixed(6);
    ...
    document.getElementById('benzene_year').textContent = M_Benzene_final.toFixed(4);
    document.getElementById('benzene_peak').textContent = G_Benzene_final.toFixed(6);

    // Calculations for Toluene
    const CI_Toluene = 0.22;
    const M_Toluene_final = CI_Toluene * M_HC_C1C5 / 100;
    const G_Toluene_final = CI_Toluene * G_HC_C1C5 / 100;

    document.getElementById('toluene_year').textContent = M_Toluene_final.toFixed(4);
    document.getElementById('toluene_peak').textContent = G_Toluene_final.toFixed(6);

    // Calculations for Xylene
    const CI_Xylene = 0.11;
    const M_Xylene_final = CI_Xylene * M_HC_C1C5 / 100;
    const G_Xylene_final = CI_Xylene * G_HC_C1C5 / 100;

    document.getElementById('xylene_year').textContent = M_Xylene_final.toFixed(4);
    document.getElementById('xylene_peak').textContent = G_Xylene_final.toFixed(6);
